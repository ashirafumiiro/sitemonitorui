...
export default class Dashboard extends Component{
    constructor(props){
        ...
        this.dataSource = new RestDataSource(
            `http://172.105.86.177/monitor/monitor/api/dashboard/${1}?timestamp=${new Date().getTime()}`,
            (err) => console.log(err));
    }
    receiveData = (data)=>{
                    ...
                    <div className="col-md-6">
                        ...
                        <div className="row my-3">
                            <div className="col-md-12">
                                ...
                                <button className="btn btn-warning m-3">Optimal</button>
